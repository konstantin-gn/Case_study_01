...
class User(Serializable):
    ...
    # user in TinyDB-Tabelle (db.json) "users" speichern
    ...
    def __init__(self, id : str , name : str, creation_date: datetime = None, last_update: datetime = None) -> None:
        ...
        # Aufruf des Konstruktors der Elternklasse Serializable
        super().__init__(id, creation_date, last_update)
        self.name = name    # zusätzlicher Attribut "name" (nur für User)

    # Daten aus DB in ein echtes User-Objekt umwandeln
    @classmethod
